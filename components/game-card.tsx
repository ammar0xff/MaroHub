...
export function GameCard({ game }: GameCardProps) {
  const imageUrl = game.thumbnail || game.background_image
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-muted">
        {imageUrl ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-card text-primary font-bold text-lg">
            {game.name}
          </div>
        )}
